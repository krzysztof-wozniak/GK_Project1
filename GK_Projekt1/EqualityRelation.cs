...
namespace GK_Projekt1
{
    public class EqualityRelation : Relation
    {
        ...
        public EqualityRelation(Vertice v1, Vertice v2, Vertice v3, Vertice v4) : base(v1, v2, v3, v4)
        {
            this.length = Math.Sqrt(Math.Pow(v1.Point.X - v2.Point.X, 2) + Math.Pow(v1.Point.Y - v2.Point.Y, 2));
        }

        public EqualityRelation(Edge e1, Edge e2) : base(e1.Vertice1, e1.Vertice2, e2.Vertice1, e2.Vertice2)
        {
